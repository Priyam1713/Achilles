...
class SovereignKernel:
    ...
    def build(cls, config_root: str | None = None) -> SovereignKernel:
        ...
        openhands_runtime = resolve_openhands_runtime()
        if openhands_runtime and llama_cpp_engine and llama_cpp_engine.base_url:
            openhands_python, mcp_python = openhands_runtime
            agent_loops.register(
                "openhands",
                OpenHandsAgentLoop(
                    openhands_python,
        ...
        swe_agent_runtime = resolve_swe_agent_runtime()
        if swe_agent_runtime and llama_cpp_engine and llama_cpp_engine.base_url:
            system = config.system.get("system", {})
            swe_agent_python, swe_agent_config = swe_agent_runtime
            agent_loops.register(
                "swe-agent",
                SWEAgentLoop(
                    swe_agent_python,
