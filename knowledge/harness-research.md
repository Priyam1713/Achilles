...
| 8 | ~~Cumulative diff sandbox~~ | Plandex | **done 2026-08-23** (`docs/FIXES.md` F-069) | `--sandbox` stages file changes outside the workspace; `diff`/`apply`/`discard` review and commit them. Writing needs no grant, applying does. Execution is **not** sandboxed |
